						...
						<div class="col-sm-9">
							<div class="media">
								<a class="pull-left margin-none" href="#">
									<img class="img-clean" src="assets/img/profile_picture.jpg" style="width: 100px; height: 100px">
								</a>
								<div class="media-body innerAll inner-2x padding-right-none padding-bottom-none">
									 <h4 class="media-heading"><a href="" class="text-inverse">Julius Kencana</a></h4>
									 <p>
									 	<i class="fa fa-fw fa-map-marker text-muted"></i> Living in Jakarta, Indonesia</p> 
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="innerAll text-right">
								<div class="btn-group-vertical btn-group-sm">
									<a href="" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Follow</a>
								</div>
							</div>
						</div>
					</div>
